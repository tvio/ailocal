...
- termínů celkem: **539**
- mělo víc laických tvarů: **6**
- označeno kontrolou: **25**
...
|---|---|---|---|
| ⚠ | akutní renální selhání | náhlé přestat ledvinami, která přestane filtrovat odpad z krve | gramaticky nesprávně ('náhlé přestat ledvinami') |
| ⚠ | akutní selhání jater | náhle nastalé přestat fungovat jater | gramaticky nesprávně ('náhle nastalé přestat fungovat jater') |
...
| ⚠ | amence | dezorientace a zmatenost | Pravděpodobný překlep v termínu 'amence' (místo amnezie nebo confused state), ale významově neodpovídá standardnímu termínu. |
| ⚠ | anafylaktický šok | Smrtelná alergická reakce | Šok nemusí být nutně smrtelný, pouze život ohrožující. |
| ⚠ | aseptická meningitida | zánět blan mozku způsobený lékem | aseptická neznamená nutně způsobenou lékem, ale pouze nebakteriální |
| ⚠ | folikulitida v místě aplikace | Zánět vlasového vlasu na miste aplikace | redundance 'vlasového vlasu' |
| ⚠ | krvácení z dásní | krvácení ze dvanácti | Krvácení z dásní není totéž co krvácení ze dvanáctníku. |
| ⚠ | lupus-like syndrom | příznaky připomínající lupénku (nebo systémový lupus) | Záměna lupusu (systémové onemocnění) s lupénkou (psoriáza), což jsou dvě různé diagnózy. |
| ⚠ | metabolická acidóza s vysokou aniontovou mezerou | porucha kyselosti krve | Příliš obecné; chybí klíčová informace o vysoké aniontové mezeře, což zásadně mění diagnostický významAcidózy. |
...
| ⚠ | peptický vřed s krvácením | Rána na žaludeční sliznici nebo dvanáctníku, která začne krýt | Překlep v textu 'začne krýt' místo 'krvácet', což je nesrozumitelné |
| ⚠ | periferní otok | nátoky na končetinách (ruce, nohy) | Slovo 'nátoky' není v češtině správný výraz pro otoky |
| ⚠ | poruchy vidění | Nechutné problémy se zrakem nebo rozostření | Slovo 'Nechutné' je nevhodné a zkresluje význam. |
| ⚠ | poruchy vidění/miosa | problémy se zrakem nebo zvětšené zúžení zorničky | Kontradikce 'zvětšené zúžení'. |
| ⚠ | přerůstání necitlivých organismů | nadměrný růst bakterií, které neovlivňují lék | nesprávný význam; 'necitlivý organismus' znamená organismus odolný vůči léku/antibiotiku, nikoliv takový, který lék neovlivňuje. |
| ⚠ | reverzibilní hyperaktivita | dočasné zvýšené pohnutí nebo neklid | nesprávný překlad; hyperaktivita v medicínském kontextu obvykle neznamená pouze 'pohyb nebo neklid', ale zvýšenou aktivitu konkrétního orgánu či systému. |
| ⚠ | rozmazané vidění(viz také bod 4.4.) | Mazani videni (viz take bod 4.4.) | text je v polštině/nesrozumitelný |
| ⚠ | selhání kostní dřeně | Nestárnutí kostní dřeně, která přestane tvořit krevní buňky | nesmyslné slovo 'Nestárnutí' namísto selhání |
| ⚠ | suchost v místě aplikace | Souska na miste aplikace | překlep 'Souska' místo 'suchost' |
| ⚠ | svědění v místě aplikace | Zapaleni na miste aplikace | záměna svědění za zapálení |
| ⚠ | tendinopatie, někdy komplikovaná rupturou | choroba šlachy, která se občas zlomí | šlacha se neláme (zlom je u kosti), správně by bylo 'trhnutí' nebo 'roztržení' |
| ⚠ | vyrážka v místě aplikace | Vyprazdnění na miste aplikace | překlep v laickém tvaru ('Vyprazdnění' místo 'vyrážka') |
| ⚠ | zvýšené jaterní enzymy | zvýšení hladiny enzymů v játrech | enzymy jsou zvýšené v krvi, nikoliv přímo 'v játrech' |
| ⚠ | zánětů žaludeční sliznice | léčba zánětu stěny žaludku | přidána slovo 'léčba', která v původním termínu není |
...
| agranulocytóza | vážný pokles bílých krvinek | 8 |  |  |
...
| akutní generalizovaná exantematózní pustulóza | rychle se šířící vyrážka s plnými malých puchýřků po celém těle | 2 | 1 |  |
...
| akutní pankreatitida | náhlý zánět slinivky břišní | 2 |  |  |
...
| akutní selhání ledvin | Náhle přestaly ledviny plnit svou funkci | 1 |  |  |
...
| alergická trombocytopenie | alergické snížení počtu krevních destiček | 2 | 1 |  |
| alergické exantémy | vyrážka způsobená alergií | 2 | 1 |  |
...
| anafylaktická reakce | Závažná alergická reakce | 2 |  |  |
| anafylaktická reakce/šok | těžká, život ohrožující alergická reakce | 1 |  |  |
| anafylaktické reakce | těžká alergická reakce | 2 |  |  |
| anafylaktické/anafylaktoidní reakce | těžká alergická reakce nebo podobná reakce, která není vyvolána alergií | 1 |  |  |
| anafylaktický šok | Smrtelná alergická reakce | 5 |  |  |
| anafylaktoidní reakce | Reakce připomínající silnou alergii, i když není způsobena alergií | 1 |  |  |
...
| angioedém | otok kůže a sliznic | 9 |  |  |
...
| dušnost | těžkosti s dýcháním a nedostatky vzduchu | 4 | 1 |  |
...
| eozinofilie | vysoký počet eozinofilů v krvi | 1 |  |  |
| epigastrický diskomfort | Nepříjemný pocit v horní části břicha pod žebry | 1 |  |  |
| epistaxe | krvácení z nosu | 3 |  |  |
| erythema multiforme | mnohotvará červená vyrážka s puchýřky | 3 |  |  |
| erytém | začervenání kůže | 3 |  |  |
...
| hemolytická anémie | rozpad červených krvinek vedoucí k chudokrevnosti | 2 |  |  |
...
| hypersenzitivní reakce | Přecitlivělost | 6 |  |  |
...
| intersticiální nefritida | zánět mezičásti ledviny | 2 |  |  |
...
| leukocytopenie | nízký počet bílých krvinek | 2 | 1 |  |
...
| lineární iga bulózní dermatóza | autoimunitní kožní nemoc s puchýři způsobená imunitním systémem | 1 |  |  |
...
| pancytopenie | pokles všech krevních buněk | 7 |  |  |
...
| paralytickém ileu | když přestala fungovat střeva a hromadí se v nich obsah | 2 | 1 |  |
...
| pokles krevního tlaku | nízký krevní tlak | 1 |  |  |
...
| poléková reakce s eozinofilií a systémovými příznaky (dress) | těžká alergická reakce na lék se zvýšením určitého typu bílých krvinek a dalšími celkovými potížemi | 1 |  |  |
...
| reakce z přecitlivělosti | nadměrná reakce organismu na látku, projevující se alergickými příznaky | 1 |  |  |
...
| retence moči | neschopnost vyprázdnit močový měchýř | 1 |  |  |
...
| stevensův - johnsonův syndrom | těžká alergická reakce postihující kůži a sliznice s puchýři a odlupováním | 1 |  |  |
...
| vaskulitida | zánět krevních cév | 2 |  |  |
| vaskulární purpura | skvrny na kůži způsobené krvácením do podkoží z malých cév | 1 |  |  |
| vertigo | závrať s pocitem rotace okolních předmětů | 3 |  |  |
| vomitus | zvracení | 1 |  |  |
| vyrážka | vyrážka | 9 |  |  |
...
- náhlý výskyt mnoha hnisavých pupínků po celém těle vyvolaný lékem  (1×)
- **rychle se šířící vyrážka s plnými malých puchýřků po celém těle**  (1×)

**alergická trombocytopenie**
- nízký počet krevních destiček vyvolaný alergií  (1×)
- **alergické snížení počtu krevních destiček**  (1×)

**alergické exantémy**
- vyrážka na kůži vyvolaná alergií  (1×)
- **vyrážka způsobená alergií**  (1×)

**dušnost**
- **těžkosti s dýcháním a nedostatky vzduchu**  (2×)
- potíže s dýcháním, pocit nedostatku vzduchu  (2×)

**leukocytopenie**
- **nízký počet bílých krvinek**  (1×)
- snížený počet bílých krvinek  (1×)

**paralytickém ileu**
- **když přestala fungovat střeva a hromadí se v nich obsah**  (1×)
- když střeva přestala fungovat a jejich obsah se neposouvá (častý stav po operacích břišní dutiny)  (1×)
